                ...
                <div className="container mx-auto px-4 relative z-20">
                    <div className="max-w-3xl">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
                            Hi, I'm <span className="text-primary">Rabbul Ansary</span>
                        </h1>
                                ...
                                <Card>
                                    <CardHeader>
                                        <div className="flex justify-between items-start">
                                            <div>
                                                ...
                                                <CardDescription>Webskitters Technology Solutions Private Limited</CardDescription>
                                            </div>
                                    ...
                                    <CardContent>
                                        <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
                                            <li>Lead the development of using NestJS and TypeScript, improving system scalability</li>
                            ...
                            <TabsContent value="education">
                                <Card>
                                    <CardHeader>
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <CardTitle>Master's in Computer Application</CardTitle>
                                                <CardDescription>Amity Online University</CardDescription>
                                            </div>
                                            <Badge>2025 - Present</Badge>
                                        </div>
                                    </CardHeader>
                                    <CardContent>
                                        <p className="text-muted-foreground">Specializing in Blockchain Technology and Distributed Ledger Applications."</p>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="mt-6">
                                    <CardHeader>
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <CardTitle>BA Honors in English</CardTitle>
                                                <CardDescription>Sidho Kanho Birsha University</CardDescription>
                                            </div>
                                            <Badge>2018 - 2021</Badge>
                                        </div>
                                    </CardHeader>
                                    <CardContent>
                                        <p className="text-muted-foreground">Graduated with first class honors in English Literature. Specialized in contemporary British fiction and post-colonial literature. Completed a thesis on narrative techniques in modern novels.</p>
                                    </CardContent>
                                </Card>
                            </TabsContent>
                        </Tabs>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-2">
                                    <li className="flex items-center">
                                        <Badge className="mr-2 bg-chart-1">Intermediate</Badge>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-2">
                                    <li className="flex items-center">
                                        <Badge className="mr-2 bg-chart-1">Intermediate</Badge>
                                        Jest, Integration Testing, Load Testing (JMeter)
                                    </li>
                                </ul>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <ul className="space-y-2">
                                    <li className="flex items-center">
                                        <Badge className="mr-2 bg-chart-1">Advanced</Badge>
                                        RESTful API Design
                                    </li>
                                    <li className="flex items-center">
                                        <Badge className="mr-2 bg-chart-1">Intermediate</Badge>
                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <Card className="text-center">
                                ...
                                <CardContent>
                                    <a href="mailto:itsrabbul@gmail.com" className="text-primary hover:underline">
                                        itsrabbul@gmail.com
                                    </a>
                                </CardContent>
                            </Card>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-muted-foreground">
                            {new Date().getFullYear()} Rabbul Ansary.
                        </p>
